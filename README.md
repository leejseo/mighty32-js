...
npm run ai:pipeline -- --mlp --epochs=5 --train-games=1800 --eval-games=6000 --train-bid=false --candidate-limit=2 --play-rollout-samples=1 --play-rollout-rate=0.015
